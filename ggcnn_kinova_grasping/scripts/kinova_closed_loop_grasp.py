...
# - Translation: [0.341, -0.190, 0.242]
# - Rotation: in Quaternion [0.890, 0.455, -0.011, 0.023]
#             in RPY (radian) [3.111, 0.040, 0.945]
#             in RPY (degree) [178.221, 2.316, 54.152]



# HOME = [0.343614305258, -0.209523953199, 0.259922802448], \
#        [-0.57361302,  0.64084903,  0.38013963, -0.34025649]


# HOME = [0.343614305258, -0.209523953199, 0.259922802448], \
#        [0.793353340, 0.608761429, 0.0, 0.0]

HOME = [0.341, -0.190, 0.242], \
       [0.89001184,  0.45524192, -0.01084549,  0.02271771]
